<?php
namespace extension\captcha;
use core\CoreErrorCode;
...
class Captcha
{
    ...
    private $code;
    //验证码的随机种子
    private $codeStr = '0123456789abcdefghjklmnpqrstuvwsyz';
    //验证码长度
    private $codeLen = 4;
    //验证码字体
    private $font;
    ...
    {
        if (!$this->checkGD()){
            throw new \Exception('php没有GD库',CoreErrorCode::SYSTEM_NOT_GD_EXTEND);
        }
        $w = $this->width;
        $h = $this->height;
